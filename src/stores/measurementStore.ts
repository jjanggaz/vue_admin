...
export const useMeasurementStore = defineStore("measurement", () => {
  ...
  const fetchCommonCodes = async (parentKey: string) => {
    ...
    try {
      const response = await request("/api/measurement/common/code", undefined, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
        body: JSON.stringify({
          // measurement 관련 공통코드 조회를 위한 파라미터
  ...
  const fetchThirdDepth = async (parentValue: string, level: number) => {
    ...
    try {
      const response = await request("/api/measurement/depth", undefined, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const fetchSearchList = async (searchParams: Record<string, unknown>) => {
    ...
    try {
      const response = await request("/api/measurement/search", undefined, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      error.value =
        err instanceof Error ? err.message : t("messages.error.measurementSearchFailed");
      throw err;
    } finally {
      loading.value = false;
    }
  ...
  const fetchMeasurementCommonCode = async (searchValue: string) => {
    loading.value = true;
    error.value = null;

    try {
      const response = await request(
        `/api/measurement/common/code/${searchValue}`,
        undefined,
        {
          method: "GET",
        }
      ...
      error.value =
        err instanceof Error
          ? err.message
          : t("messages.error.measurementCommonCodeRetrieveFailed");
      throw err;
    } finally {
      loading.value = false;
    }
  ...
  // 상세 깊이 코드 조회 (/api/measurement/depth/detail)
  const fetchDepthDetail = async (codeGroup: string, codeLevel: number = 4) => {
    loading.value = true;
    error.value = null;

    try {
      const response = await request("/api/measurement/depth/detail", undefined, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const fetchDepthDetailBySearchType = async (searchKey: string) => {
    ...
    try {
      const response = await request(
        `/api/measurement/depth/detail/searchType/${encodeURIComponent(searchKey)}`,
        undefined,
        {
          method: "GET",
        }
  ...
  // Excel 템플릿 다운로드
  const downloadExcelTemplate = async (measurementName: string) => {
    loading.value = true;
    error.value = null;

    try {
      const response = await request(
        `/api/measurement/tempExcel/${encodeURIComponent(measurementName)}`,
        undefined,
        {
          method: "GET",
        }
  ...
  // 배관 Excel 파일 업로드
  const uploadMeasurementExcel = async (measurementName: string, excelFile: File) => {
    loading.value = true;
    error.value = null;
    ...
    try {
      ...
      const response = await request(
        `/api/measurement/uploadModelExcel/${encodeURIComponent(measurementName)}`,
        undefined,
        {
          method: "POST",
          body: formData,
      ...
      error.value =
        err instanceof Error
          ? err.message
          : t("messages.error.measurementExcelUploadFailed");
      throw err;
    } finally {
      loading.value = false;
    }
  ...
  // 모델 ZIP 파일 업로드
  const uploadModelZip = async (measurementName: string, zipFile: File) => {
    loading.value = true;
    error.value = null;
    ...
    try {
      ...
      const response = await request(
        `/api/measurement/uploadModelZip/${encodeURIComponent(measurementName)}`,
        undefined,
        {
          method: "POST",
          body: formData,
  ...
  const deleteMeasurement = async (
    ...
    try {
      const response = await request(
        `/api/measurement/delete/${encodeURIComponent(equipmentId)}`,
        undefined,
        {
          method: "POST",
      ...
      error.value =
        err instanceof Error ? err.message : t("messages.error.measurementDeleteFailed");
      throw err;
    } finally {
      loading.value = false;
    }
  ...
  const fetchMeasurementDetailCommon = async (equipmentType: string) => {
    loading.value = true;
    error.value = null;

    try {
      const response = await request(
        `/api/measurement/detail/common/${encodeURIComponent(equipmentType)}`,
        undefined,
        { method: "POST" }
      );
      ...
      error.value =
        err instanceof Error
          ? err.message
          : t("messages.error.measurementCommonDetailRetrieveFailed");
      throw err;
    } finally {
      loading.value = false;
    }
  ...
  const fetchMeasurementDetailFiles = async (
    equipmentId: string,
    params: {
      model_file_id?: string;
      rvt_file_id?: string;
    ...
    try {
      const response = await request(
        `/api/measurement/detail/files/${encodeURIComponent(equipmentId)}`,
        undefined,
        {
          method: "POST",
          body: JSON.stringify(params),
      ...
      error.value =
        err instanceof Error
          ? err.message
          : t("messages.error.measurementFileDetailRetrieveFailed");
      throw err;
    } finally {
      loading.value = false;
    }
  ...
  const updateMeasurement = async (
    ...
    try {
      ...
      const response = await request(
        `/api/measurement/update/${encodeURIComponent(equipmentId)}`,
        undefined,
        {
          method: "POST",
          body: formData,
      ...
      error.value =
        err instanceof Error ? err.message : t("messages.error.measurementUpdateFailed");
      throw err;
    } finally {
      loading.value = false;
    }
  ...
  const searchFormula = async (equipmentType: string) => {
    ...
    try {
      const response = await request("/api/measurement/search/formula", undefined, {
        method: "POST",
  ...
  const createFormula = async (params: {
    ...
    try {
      ...
      const response = await request("/api/measurement/create/formula", undefined, {
        method: "POST",
        body: formData,
      });
  ...
  const deleteFormula = async (formulaId: string) => {
    ...
    try {
      const response = await request(
        `/api/measurement/delete/formula/${encodeURIComponent(formulaId)}`,
        undefined,
        {
          method: "DELETE",
        }
  ...
  const createPriceHistory = async (params: {
    ...
    try {
      const response = await request("/api/measurement/price/history", undefined, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  return {
    ...
    fetchThirdDepth,
    fetchSearchList,
    fetchMeasurementCommonCode,
    fetchDepthDetail,
    fetchDepthDetailBySearchType,
    downloadExcelTemplate,
    uploadMeasurementExcel,
    uploadModelZip,
    deleteMeasurement,
    fetchMeasurementDetailCommon,
    fetchMeasurementDetailFiles,
    updateMeasurement,
    searchFormula,
    createFormula,
    deleteFormula,
