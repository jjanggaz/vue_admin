<template>
  <div class="pagination">
    ...
    <button 
      class="pagination-btn"
      :disabled="currentPage === resolvedTotalPages"
      @click="$emit('page-change', resolvedTotalPages)"
    >
      &raquo;
    </button>
  </div>
...
// totalPages가 주어지지 않으면 totalCount/pageSize로 계산
...
const visiblePages = computed(() => {
  ...
  const totalPages = resolvedTotalPages.value
...
const onClickPage = (p: number | string) => {
  if (typeof p === 'number') {
    emit('page-change', p)
  }
}
