    ...
    <div class="action-bar">
      <div class="search-bar">
        <div class="group-form">
          ...
          <div class="form-item">
            <select v-model="searchOptionInput" class="form-select">
              <option value=""></option>
            </select>
          </div>
        </div>
        <div class="group-form">
          ...
          <button class="btn btn-primary btn-search" @click="handleSearch">검색</button>
        </div>
      ...
      <div class="modal-container">
        ...
        <div class="modal-body">
          <dl class="column-regist">
            ...
            <dt>모드</dt>
            <dd>
              <input type="text" class="form-input" placeholder="모드를 입력하세요" />
            </dd>
            ...
            <dt>P&ID 정보개요</dt>
            <dd>
              <input type="text" class="form-input" placeholder="P&ID 정보개요를 입력하세요" />
            </dd>
            <dt>정합성 체크</dt>
            <dd>
...
const tableColumns: TableColumn[] = [
  ...
  { key: 'viewDetail', title: '상세보기', sortable: true, formatter: (value) => formatDate(value)  },
]
...
const loadProcessList = async (sortInfo?: { key: string; direction: 'asc' | 'desc' }) => {
  loading.value = true
  try {
    // API 호출로 데이터 로드
    // 임시 샘플 데이터
